...
CODE42_USER_DEACTIVATION_ID_SUCCESS_MSG = 'User with ID {user} deactivated {msg}'
CODE42_USER_DEACTIVATION_USERNAME_SUCCESS_MSG = 'User named {user} deactivated {msg}'
CODE42_USER_ACTIVATION_ID_SUCCESS_MSG = 'User with ID {user} activated {msg}'
CODE42_USER_ACTIVATION_USERNAME_SUCCESS_MSG = 'User named {user} activated {msg}'
